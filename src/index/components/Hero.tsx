...
export default function Hero() {
  return (
    <div className="px-52 w-screen">
      <div className="grid grid-cols-2 xl:max-w-7xl xl:mx-auto mt-10 bg-sky-100 rounded-[2.5rem] overflow-hidden">
        <article className="p-10">
          ...
          <div className="flex gap-x-5 my-5">
            <p className="flex gap-x-2 items-center bg-black/10 rounded-full px-4 py-2">
              <CgSandClock className="w-5 h-5" />
              30 Minutes
            </p>
            <p className="flex gap-x-2 items-center bg-black/10 rounded-full px-4 py-2">
